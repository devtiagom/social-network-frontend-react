...
export default props => (
    <div className="card post">
        <div className="card-header bg-primary">
            <h5 className="card-title text-white">Título da Postagem</h5>
            <h6 className="card-subtitle">Autor da Postagem</h6>
        </div>
        ...
        <div className="card-footer bg-primary">
            <p className="card-text text-white">Likes: 10 Deslikes: 2</p>
        </div>
    </div>
);